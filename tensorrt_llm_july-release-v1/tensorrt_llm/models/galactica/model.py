...
class GALAIDecoderLayer(Module):
    ...
    def __init__(self,
        ...
        assert self.pre_norm == True, 'Galactica is pre_norm'
...
class GALAIModel(Module):
    ...
    def __init__(self,
        ...
        self.layers = ModuleList([
            GALAIDecoderLayer(hidden_size=hidden_size,
...
class GALAILMHeadModel(GALAIModel):
