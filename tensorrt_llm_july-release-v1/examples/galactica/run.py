...
def parse_arguments():
    ...
    parser.add_argument('--engine_dir', type=str, default='galactica_outputs')
    ...
    parser.add_argument('--input_text',
                        type=str,
                        default='The Transformer architecture [START_REF]')
    parser.add_argument(
        '--input_tokens',
        dest='input_file',
        type=str,
...
def generate(
    max_output_len: int,
    log_level: str = 'error',
    engine_dir: str = 'galactica_outputs',
    input_text: str = 'The Transformer architecture [START_REF]',
    input_file: str = None,
    output_csv: str = None,
    output_npy: str = None,
    ...
    engine_name = get_engine_name('galactica', dtype, world_size, runtime_rank)
